 ...
 *
 * Copy this file to frontend/src/config/theme.js for a new deployment.
 * Edit hex values here to match the fund's brand colors.
 * After changing colors, also update the matching CSS variables in
 * frontend/src/index.css (see comments next to each value).
 *
 * Run `/configure-theme <hex>` in Claude Code for guided color updates.
 */
